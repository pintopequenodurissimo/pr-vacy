  ...
  return (
    <div className="card-elevated p-4 sm:p-6">
      ...
      <div className="mb-4">
        ...
        <div className="plan-card-featured flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4">
          <div>
      ...
      <div className="border border-border rounded-xl overflow-hidden">
        ...
        {showPromos && (
          <div className="border-t border-border">
            {/* Quarterly plan */}
            <div className="plan-card m-2 sm:m-3 mb-0 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-3">
            ...
            {/* Annual plan */}
            <div className="plan-card m-2 sm:m-3 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-3">
              <div className="flex items-start sm:items-center gap-2 sm:gap-3">
                <div className="min-w-0">
